...
4. Rather than testing only values, you can also test values' datatypes using any of the following:
   - :anything
   - :any_iso8601_date (a string, like "2018-07-04")
   - :any_iso8601_time (a string, like "12:56:11")
   - :any_iso8601_datetime (a string, like "2018-07-04 12:56:11" or "2018-07-04T12:56:11")
...
def deps do
  [
    {:recursive_selective_match, "~> 0.2.4"}
  ]
end
```
